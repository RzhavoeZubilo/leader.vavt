...
class block_vavt_fav_event extends block_base
{
    ...
    public function get_content() {
        ...
        $data = $DB->get_records_sql("SELECT * FROM mdl_vavt_favorite WHERE usermodified = {$USER->id} AND nameplugin = 'event'");
...
//print_object($render);
        $this->content->text = $OUTPUT->render_from_template("block_vavt_fav_event/item", $render);
