...
- через запятую (наличие или отсутствие пробела не играет никакой роли) укажите 3 параметра (имя, или ссылка или решетка, иконка);<br>
- # указывается вместо ссылки у пунктов меню, которые являются заголовками раскрывающегося подменю;<br>
...
После добавления нового пункта, рекомендуется очистить кэши системы (Администрирование -> Разработка -> Очистить кэши).
</p>
<p>
