...
class user_editadvanced_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('html', '<a class="d-flex" style="justify-content: center" href="http://www.vavt.ru/hrdep/site/pd" target="_blank">Согласие на обработку персональных данных</a>');
