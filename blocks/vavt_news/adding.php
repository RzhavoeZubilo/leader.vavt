...
if ($mform->is_cancelled()) {
    ...
    if($toform->action === 'edit'){
        ...
        $text = file_prepare_draft_area($draftitemid, $context->id, 'block_vavt_news', 'content', $id, EDITOR_OPTIONS, $text);
...
// text
    ...
    $data->content = file_save_draft_area_files($draftitemid, $context->id, 'block_vavt_news', 'content', $itemid, EDITOR_OPTIONS, $data->content);
