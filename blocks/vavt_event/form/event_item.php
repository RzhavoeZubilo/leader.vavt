...
class event_item extends \moodleform
{
    ...
    function definition()
    {
        ...
        $mform->addElement('editor', 'paragraph', 'Описание мероприятия', null, $editoroptions);
        $mform->addElement('date_time_selector', 'dateevent', 'Дата проведения');
