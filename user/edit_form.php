...
class user_edit_form extends moodleform {
    ...
    public function definition () {
        ...
        $mform->addElement('html', '<a class="d-flex" style="justify-content: center; margin-bottom: 25px;" href="http://www.vavt.ru/hrdep/site/pd" target="_blank">Согласие на обработку персональных данных</a>');
